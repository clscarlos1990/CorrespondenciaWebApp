...
namespace CorrespondenciaWebApp.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(DB_CorrespondenciaContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,Nombre,Contrasena,Estado")] Usuario usuario)
        {
